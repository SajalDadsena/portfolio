...
const Contact = () => {
    ...
    return (
        <section className="contact_section" id="contact">
            <h2 className="section_title">Contact Me</h2> <br></br>
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">sajaldadsenarb@gmail.com</span>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">+91-7470711183</span>
